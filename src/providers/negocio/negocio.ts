...
export class NegocioProvider {
  ...
  getAbonos() {
    return this.http.get('https://gmorentin.000webhostapp.com/listarabonos.php?idusuario='+NavParams.prototype.data);
  }

  deleteAbono(idabono) {
    return this.http.get('https://gmorentin.000webhostapp.com/eliminarabono.php?idabono=' + idabono);
  }

  putAbono(registro) {
    var uri = "https://gmorentin.000webhostapp.com/agregarabono.php?cantidad=" + registro.cantidad
  ...
  updateAbono(registro) {
    var uri = "https://gmorentin.000webhostapp.com/actualizarabono.php?idabono=" + registro.idabono
    + "&cantidad=" + registro.cantidad
    + "&idventa=" + registro.idventa
    + "&idusuario=" + NavParams.prototype.data;
